...
"resource": {
  ...
  "rules":[
    ...
    [["if",0,3],["add",3]],
    [["if",0,4],["add",4,6,61]],
    [["if",5],["add",5,34,38,44,47,55]],
    [["if",6,7,8],["add",5,37,39,54]],
    [["if",9,10,11,12],["add",7,60]],
    [["if",9,10,12,13],["add",7,57]],
    [["if",0,14],["unless",15,16,17,18],["add",8]],
    [["if",0,19],["add",9]],
    [["if",0,20],["add",10]],
    [["if",21,22,23],["add",11,51,52]],
    [["if",0,24,25],["add",12]],
    [["if",26],["add",13]],
    [["if",6,8,27],["add",14]],
    [["if",28],["add",15]],
